	...
	games: [
		{
			...
			color: 'cinnamon',
			rules:
				'Хорошие новости! У вас есть 5 жизней и ограничено время “жизни” слова: нужно верно угадать, как переводится слово, которое вы увидите на экране. Вы можете играть с клавиатуры - используйте клавиши 1, 2, 3 и 4. Игра начнётся, как только вы нажмёте на кнопку “OK”.',
		},
		{
			linkName: 'Спринт',
			linkId: 'sprint',
			...
			color: 'ocean-green',
			rules:
				'Хорошие новости! У вас есть 60 секунд, чтобы угадать 20 слов. Вы можете играть с клавиатуры - используйте клавиши "влево" и "вправо". Игра начнётся, как только вы нажмёте на кнопку “OK”.',
		},
		{
			linkName: 'Аудиовызов',
			linkId: 'audiogame',
			...
			color: 'cardinal',
			rules:
				'Хорошие новости! Прослушав слово, вам нужно угадать его перевод. Вы можете играть с клавиатуры - используйте клавиши 1, 2, 3, 4 и "enter". Игра начнётся, как только вы нажмёте на кнопку “OK”.',
		},
		{
			...
			color: 'secondary',
			rules:
				'Хорошие новости! Вам нужно составить оригинальное слово по переводу. Вы можете играть с клавиатуры - используйте клавиши "влево", "вправо", "enter" и "пробел". Игра начнётся, как только вы нажмёте на кнопку “OK”.',
		},
	],
};
...
export const ourTeammates = [
	{
		...
		githubLink: 'https://github.com/AlesyaKuptsova',
	},
	{
		name: 'Дима',
		src: leela,
