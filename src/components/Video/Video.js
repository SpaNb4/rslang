		...
		<section className={c.section}>
			...
			<div className={classes.wrapper}>
				...
				<p className={classes.text}>
					...
					практике. Например, поиграть в любую из наших игр: „Саванна“, „Спринт“, „Аудиовызов“ и бонусная
					„Конструктор“. Что бы вы могли отслеживать свои результаты у нас есть страница статистики. Если вы
					зарегистрируетесь, то сможете управлять своим словарём. А если подзабыли изученные слова, то
					„Викторина“ поможет освежить ваши знания. Учите вместе с нами!
				</p>
			</div>
		</section>
	);
